...
$colname_rsSubmits = "-1";
if (isset($_POST['crn'])) {
  $colname_rsSubmits = $_POST['crn'];
}
mysql_select_db($database_ppmawards2011, $ppmawards2011);
$query_rsSubmits = sprintf("SELECT * FROM submits WHERE firstName = %s ORDER BY id ASC", GetSQLValueString($colname_rsSubmits, "text"));
...
<br />
<div id="table2">
  <h2>CRN Search &gt; <a href="add.php">Add new</a></h2><p><a style="color:#000;" href="<?php echo $logoutAction ?>">Log Out</a></p>
  <p><strong>Your search is for: <? echo $_POST[crn]; ?></strong></p>
<br /></div>
<div id="table2">
<? if ($row_rsSubmits['firstName'] == true ) {?>
<table width="95%" border="0" cellpadding="5">
  ...
  <?php else: ?>
 	...
 	<td valign="top"><a href="index_secure_edit.php?id=<?php echo $row_rsSubmits['id']; ?>">Edit Status</a></td>
