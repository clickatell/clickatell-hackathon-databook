...
$query_pod = "SELECT * FROM adminlist ORDER BY id DESC";
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                <thead>
                  <tr>
                    <th width="16%">Username <i class="fa fa-sort"></i></th>
                ...
                <tbody>
                  <?php do { ?>
  <tr>
    <td><?php echo $row_pod['user']; ?></td>
    <td><a href="edit-user.php?id=<?php echo $row_pod['id']; ?>"><span class="label label-success">EDIT</span></a></td>
    <td><a href="delete-user.php?id=<?php echo $row_pod['id']; ?>" onclick="return makesure();"><span class="label label-danger">DELETE</span></a></td>
  </tr>
