...
<body>
	<div id="logincontainer">
    	<div id="loginbox">
            ...
            <div id="innerlogin">
            	<form METHOD="POST" id="loginForm" action="<?php echo $loginFormAction; ?>">
                  ...
                  <p>Enter your password:</p>
                    ...
                    <!--<p><a href="#" title="Forgoteen Password?">Forgotten Password?</a></p>--><p style="color: #F00;">Incorrect details, please try again.</p>
                </form>
            </div>
        </div>
