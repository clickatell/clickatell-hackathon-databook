  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Edit <small>Proof of Delivery</small></h1>
            <ol class="breadcrumb">
              <li><a href="index.html"><i class="fa fa-dashboard"></i> Dashboard</a></li>
              <li class="active"><i class="fa fa-edit"></i> Edit Proof of delivery</li>
            </ol>
        ...
        <div class="row">
          ...
          <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data" >
           ...
           <div class="form-group">
               ...
               <input name="crn" type="text" class="form-control" id="crn" value="<?php echo $row_Recordset1['firstName']; ?>" />
                <p class="help-block">Enter the CR number above</p>
              </div>
                <div class="form-group">
                <label>POD</label>
              <input name="crnscan" type="file" class="logo_upload" id="crnscan" onchange="checkOneFileUpload(this,'',true,'','','','','','','')" />
              </div>
              <button type="submit" class="btn btn-default">Edit POD</button>
