...
$query_pod = "SELECT * FROM submits ORDER BY id DESC";
$pod = mysql_query($query_pod, $ppmawards2011) or die(mysql_error());
$row_pod = mysql_fetch_assoc($pod);
$totalRows_pod = mysql_num_rows($pod);

mysql_select_db($database_ppmawards2011, $ppmawards2011);
$query_users = "SELECT * FROM adminlist";
$users = mysql_query($query_users, $ppmawards2011) or die(mysql_error());
...
<div id="wrapper">
 ...
 <?php require_once('includes/top_nav.php'); ?>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Proof of Deliveries <small>pod</small></h1>
            <ol class="breadcrumb">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading"><?php echo $totalRows_pod ?></p>
                    <p class="announcement-text">Total PODs</p>
                  </div>
                </div>
              </div>
             <!-- <a href="#">
